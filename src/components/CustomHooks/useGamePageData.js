...
const useGamePageData = (id)=>{
    ...
    const {screenshots, fetchScreenshots, mainScreenshot, setMainScreenshot, screenshotsExist, screenshotsLoading} = useGameScreenshots();
    ...
    },[gameApi.data, screenshots, gameApi.loading]);
