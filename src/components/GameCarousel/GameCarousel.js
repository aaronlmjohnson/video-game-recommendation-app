...
const PopularGames = ({ games, subset, shiftLeft, shiftRight, positionNames, fetchGame, setGamePageOpen, animationNames, gamesExist })=>{
    return (
        <div id="popular-games">
            ...
            <div id="popular-games-carousel">
                {gamesExist && games.map((game, i)=>{
                    return <GameInfoCard
                        carouselPosition = {subset.includes(i) ? positionNames(subset.indexOf(i)) : "inactive"}
                        name={game.name} 
